...
<div class="container d-flex justify-content-between p-3">
      ...
      <div class="row">
        <div class="col-lg-6 d-flex flex-column justify-content-center text-justify pt-4 pt-lg-0 order-2 order-lg-1 text-white" data-aos="fade-up" data-aos-delay="200">
          <h1>Solución para el transporte de los niños</h1>
          <h3 id="gray">Somos una compañia dedicada al monitoreo de transportes escolares y establecer contacto con los funcionarios responsables de llevarlos a su destino.
          </h3>
          <div class="d-flex justify-content-center justify-content-lg-start">
            <a href="#about" class="btn-get-started scrollto btn btn-primary mx-2">Misión</a>
            <a href="" class="glightbox btn-watch-video btn btn-primary"><span>Visión</span></a>
          </div>
        </div>
    ...
    <section id="about" class="about bg-white p-3">
      <div class="container" data-aos="fade-up">
        ...
        <div class="row content">
          <div class="col-lg-6">
            <p>
              Brindamos una aplicación con el proposito de gestionar información de rutas escolares para informar a acudientes y funcionarios de establecimientos educativos para menores.
