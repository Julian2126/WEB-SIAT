            ...
            @csrf
              <div class="row">
                <div class="col-6 py-2">
                  ...
                  <input type="text" class="form-control" placeholder="Ej: Alejandro" id="Nombre" name="Nombre"/>
                </div>

                <div class="col-6 py-2">
                  <strong> APELLIDOS:</strong>
                  <input type="text" class="form-control" placeholder="Ej: Torres"  id="Apellido" name="Apellido"/>
                </div>
                ...
                <div class="col-6 py-2">
                  ...
                  <div class="col-6 py-2">
                    <strong> GRADO:</strong>
                    <input type="text" class="form-control" placeholder="Ej: 5" id="Grado" name="Grado">
                  </div>

                  <div class="col-6 py-2">
                    <strong> EDAD: </strong>
                    <input type="number" class="form-control" placeholder="Ej: 9" id="Edad" name="Edad"/>
                  </div>

                  <div class="col-6 py-2">
                    <strong> ID RUTA: </strong>
                    <input type="text" class="form-control" placeholder="Ej: 1" id="Id_ruta" name="Id_ruta"/>
                  </div>
