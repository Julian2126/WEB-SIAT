...
@section('content')
    ...
    <h1 class="h3 mb-2 text-gray-800 text-success">Acudientes</h1>
        ...
        <form>
          <div class="row">
            ...
            <div class="col-6">
              ...
              <input type="text" class="form-control" placeholder="ej: Suarez">
            </div>
            <div class="col-6">
            ...
            <div class="col-6 py-4">
              ...
              <a href="acunuevo" class="btn btn-success col-5">Nuevo</a>
            </div>
          </div>
        </form>
      </div>
