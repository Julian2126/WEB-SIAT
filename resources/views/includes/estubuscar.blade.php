...
<div class="row justify-content-center py-3">
    ...
    <div class="card col-8 alert-success border-success">
      <div class="card-body">
        ...
        </svg> Alejandro Torres</h3>
        <form>
          <div class="row">
            <div class="col-6 py-2 ">
              <strong> NOMBRES:</strong>
              <input class="form-control " id="disabledInput" type="text" placeholder="Alejandro" disabled="">
              
            </div>
            <div class="col-6 py-2">
              <strong> APELLIDOS:</strong>
              <input class="form-control" id="disabledInput" type="text" placeholder="Torres" disabled="">
            ...
            <div class="col-6 py-2">
              ...
              <div class="col-12 py-2">
                ...
                <input class="form-control" id="disabledInput" type="text" placeholder="InstitucionPL" disabled="">
              </div>
