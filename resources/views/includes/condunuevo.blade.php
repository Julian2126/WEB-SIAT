            ...
            <form>
              <div class="row">
                <div class="col-6 py-2">
                  ...
                  <input type="text" class="form-control" placeholder="Ej: Jefferson">
                </div>
                <div class="col-6 py-2">
                  <strong> APELLIDOS:</strong>
                  <input type="text" class="form-control" placeholder="Ej: Hernandez">
                </div>
                <div class="col-6 py-2">
                ...
                <div class="col-6 py-4">
                  <a href="conductores" class="btn btn-danger col-5">Cancelar</a>
