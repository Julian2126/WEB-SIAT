            ...
            <form>
              <div class="row">
                ...
                <div class="col-6 py-2">
                  ...
                  <input class="form-control" id="disabledInput" type="text" placeholder="Perez" disabled="">
                ...
                <div class="col-6 py-2">
                  ...
                  <div class="col-6 py-2">
                    <strong> CARGO:</strong>
                    <input class="form-control" id="disabledInput" type="text" placeholder="Monitor" disabled="">
